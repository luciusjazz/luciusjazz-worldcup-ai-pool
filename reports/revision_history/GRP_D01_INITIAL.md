...
## Notas
EnsembleModel | xG Germany=1.921 Italy=1.523 | context_adj=+0.0000
...
| Historical World Cup Analyst | 0.06 | 0.70 | -0.050 | -0.050 | +0.0000 | xG total=3.44 acima da média histórica (2.64). Regressão à média aplicada. |
...
- λ_casa × (1 + +0.0000) = 1.921
- λ_visit × (1 - +0.0000) = 1.523
