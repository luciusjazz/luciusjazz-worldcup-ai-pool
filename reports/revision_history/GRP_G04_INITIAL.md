...
## Palpite
Venezuela **0** x **0** Austria

## Probabilidades
- Vitória Venezuela: 38.7%
- Empate: 27.1%
- Vitória Austria: 34.2%
...
## Notas
EnsembleModel | xG Venezuela=1.23 Austria=1.125 | context_adj=+0.0000
...
| Historical World Cup Analyst | 0.06 | 0.70 | +0.000 | +0.000 | +0.0000 | xG total=2.35 dentro da faixa histórica. Ajuste neutro. |
...
- λ_casa × (1 + +0.0000) = 1.230
- λ_visit × (1 - +0.0000) = 1.125
