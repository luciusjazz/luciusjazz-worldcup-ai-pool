...
## Palpite
Portugal **1** x **1** England

## Probabilidades
- Vitória Portugal: 47.3%
- Empate: 19.7%
- Vitória England: 33.0%
...
## Notas
EnsembleModel | xG Portugal=2.154 England=1.778 | context_adj=+0.0000
...
| Historical World Cup Analyst | 0.06 | 0.70 | -0.050 | -0.050 | +0.0000 | xG total=3.93 acima da média histórica (2.64). Regressão à média aplicada. |
...
- λ_casa × (1 + +0.0000) = 2.154
- λ_visit × (1 - +0.0000) = 1.778
