...
## Palpite
Croatia **1** x **0** Belgium

## Probabilidades
- Vitória Croatia: 39.0%
- Empate: 23.5%
- Vitória Belgium: 37.5%
...
## Notas
EnsembleModel | xG Croatia=1.609 Belgium=1.563 | context_adj=+0.0000
...
| Historical World Cup Analyst | 0.06 | 0.70 | -0.050 | -0.050 | +0.0000 | xG total=3.17 acima da média histórica (2.64). Regressão à média aplicada. |
...
- λ_casa × (1 + +0.0000) = 1.609
- λ_visit × (1 - +0.0000) = 1.563
