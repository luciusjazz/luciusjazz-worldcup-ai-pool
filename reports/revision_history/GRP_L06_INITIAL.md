...
## Palpite
Uzbekistan **0** x **0** Jordan

## Probabilidades
- Vitória Uzbekistan: 38.7%
- Empate: 30.7%
- Vitória Jordan: 30.5%
...
## Notas
EnsembleModel | xG Uzbekistan=1.065 Jordan=0.886 | context_adj=+0.0000
...
| Historical World Cup Analyst | 0.06 | 0.70 | +0.040 | +0.040 | +0.0000 | xG total=1.95 abaixo da média histórica (2.64). Leve boost aplicado. |
...
- λ_casa × (1 + +0.0000) = 1.065
- λ_visit × (1 - +0.0000) = 0.886
