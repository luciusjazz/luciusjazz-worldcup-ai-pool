# Tunisia vs South Africa — INITIAL
...
## Palpite
Tunisia **0** x **0** South Africa

## Probabilidades
- Vitória Tunisia: 39.4%
- Empate: 28.8%
- Vitória South Africa: 31.8%
...
## Notas
EnsembleModel | xG Tunisia=1.155 South Africa=0.994 | context_adj=+0.0000
...
| Historical World Cup Analyst | 0.06 | 0.70 | +0.000 | +0.000 | +0.0000 | xG total=2.15 dentro da faixa histórica. Ajuste neutro. |
...
- λ_casa × (1 + +0.0000) = 1.155
- λ_visit × (1 - +0.0000) = 0.994
